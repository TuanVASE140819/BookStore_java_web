        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            ...
            <ul class="navbar-nav badge-light">
                <c:if test="${sessionScope.USER.getRoleID() == 1}">
                    <li class="nav-item">
                             <a class="nav-item text-uppercase" href="MainController?action=manager">Manager Book</a>
                    </li>
                    <li class="nav-item">
                            <a class="nav-link text-uppercase" href="MainController?action=discount">Create Discount</a>
                    </li>
                </c:if>
